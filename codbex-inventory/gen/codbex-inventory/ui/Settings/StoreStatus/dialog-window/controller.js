	...
	.controller('PageController', ($scope, $http, ViewParameters, EntityService) => {
		...
		$scope.create = () => {
			...
			EntityService.create(entity).then((response) => {
				...
				Notifications.show({
					title: 'StoreStatus',
					description: 'StoreStatus successfully created',
					type: 'positive'
				});
				$scope.cancel();
			}, (error) => {
				...
				$scope.$evalAsync(() => {
					$scope.errorMessage = `Unable to create StoreStatus: '${message}'`;
				});
		...
		$scope.update = () => {
			...
			EntityService.update(id, entity).then((response) => {
				...
				Notifications.show({
					title: 'StoreStatus',
					description: 'StoreStatus successfully updated',
					type: 'positive'
				});
				$scope.cancel();
			}, (error) => {
				const message = error.data ? error.data.message : '';
				$scope.$evalAsync(() => {
					$scope.errorMessage = `Unable to update StoreStatus: '${message}'`;
				});
				console.error('EntityService:', error);
			});
		};
