angular.module('page', ['blimpKit', 'platformView', 'platformLocale']).controller('PageController', ($scope, ViewParameters) => {
	...
	$scope.filter = () => {
		...
		if (entity.GoodsReceipt !== undefined) {
		...
		Dialogs.postMessage({ topic: 'codbex-inventory.GoodsReceipts.GoodsReceiptItem.entitySearch', data: {
			entity: entity,
			filter: filter
		}});
		$scope.cancel();
	...
	$scope.cancel = () => {
		Dialogs.closeWindow({ id: 'GoodsReceiptItem-filter' });
	};
