angular.module('page', ['blimpKit', 'platformView', 'EntityService'])
	...
	.controller('PageController', ($scope, $http, EntityService, Extensions, ButtonStates) => {
			...
			EntityService.count(filter).then((resp) => {
				...
				EntityService.search(filter).then((response) => {
					...
					Dialogs.showAlert({
						...
						message: `Unable to list/filter StockAdjustmentItem: '${message}'`,
				...
				Dialogs.showAlert({
					title: 'StockAdjustmentItem',
					message: `Unable to count StockAdjustmentItem: '${message}'`,
					type: AlertTypes.Error
				});
				console.error('EntityService:', error);
			});
		...
		$scope.deleteEntity = (entity) => {
			let id = entity.Id;
			Dialogs.showDialog({
				title: 'Delete StockAdjustmentItem?',
				message: `Are you sure you want to delete StockAdjustmentItem? This action cannot be undone.`,
				buttons: [{
					id: 'delete-btn-yes',
				...
				if (buttonId === 'delete-btn-yes') {
					EntityService.delete(id).then(() => {
						...
						Dialogs.showAlert({
							title: 'StockAdjustmentItem',
							message: `Unable to delete StockAdjustmentItem: '${message}'`,
							type: AlertTypes.Error,
						});
						console.error('EntityService:', error);
					});
