	...
	.controller('PageController', ($scope, $http, ViewParameters, EntityService) => {
		...
		$scope.create = () => {
			...
			EntityService.create(entity).then((response) => {
				...
				Notifications.show({
					...
					description: 'GoodsIssueItem successfully created',
					type: 'positive'
				});
				$scope.cancel();
			}, (error) => {
				...
				Dialogs.showAlert({
					title: 'GoodsIssueItem',
					message: `Unable to create GoodsIssueItem: '${message}'`,
		...
		$scope.update = () => {
			...
			EntityService.update(id, entity).then((response) => {
				...
				Notifications.show({
					title: 'GoodsIssueItem',
					description: 'GoodsIssueItem successfully updated',
					type: 'positive'
				});
				$scope.cancel();
			}, (error) => {
				...
				Dialogs.showAlert({
					title: 'GoodsIssueItem',
					message: `Unable to update GoodsIssueItem: '${message}'`,
					type: AlertTypes.Error
				});
				console.error('EntityService:', error);
			});
