...
export interface DeliveryNoteItemEntityEvent {
...
export interface DeliveryNoteItemUpdateEntityEvent extends DeliveryNoteItemEntityEvent {
...
export class DeliveryNoteItemRepository {
    ...
    public findById(id: number, options: DeliveryNoteItemEntityOptions = {}): DeliveryNoteItemEntity | undefined {
