...
export interface StockRecordDirectionEntityEvent {
...
export interface StockRecordDirectionUpdateEntityEvent extends StockRecordDirectionEntityEvent {
...
export class StockRecordDirectionRepository {
    ...
    public findById(id: number, options: StockRecordDirectionEntityOptions = {}): StockRecordDirectionEntity | undefined {
